// Generated from SnowflakeParser.g4 by ANTLR 4.13.2
package snowflake;
...
public interface SnowflakeParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SnowflakeParser#projection_alias}.
	 * @param ctx the parse tree
	 */
	void enterProjection_alias(SnowflakeParser.Projection_aliasContext ctx);
	/**
	 * Exit a parse tree produced by {@link SnowflakeParser#projection_alias}.
	 * @param ctx the parse tree
	 */
	void exitProjection_alias(SnowflakeParser.Projection_aliasContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SnowflakeParser#table_object_name}.
	 * @param ctx the parse tree
	 */
	void enterTable_object_name(SnowflakeParser.Table_object_nameContext ctx);
	/**
	 * Exit a parse tree produced by {@link SnowflakeParser#table_object_name}.
	 * @param ctx the parse tree
	 */
	void exitTable_object_name(SnowflakeParser.Table_object_nameContext ctx);
	/**
	 * Enter a parse tree produced by {@link SnowflakeParser#relation_alias}.
	 * @param ctx the parse tree
	 */
	void enterRelation_alias(SnowflakeParser.Relation_aliasContext ctx);
	/**
	 * Exit a parse tree produced by {@link SnowflakeParser#relation_alias}.
	 * @param ctx the parse tree
	 */
	void exitRelation_alias(SnowflakeParser.Relation_aliasContext ctx);
	/**
