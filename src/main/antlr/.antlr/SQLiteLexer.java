// Generated from c:/Users/kyle.luoma/Research Projects/SQLParserQueryAnalyzer/src/main/antlr/SQLiteLexer.g4 by ANTLR 4.13.1
...
public class SQLiteLexer extends Lexer {
	...
	public static final int
		...
		LT=18, LT_EQ=19, GT=20, GT_EQ=21, EQ=22, NOT_EQ1=23, NOT_EQ2=24, BACKTICK=25, 
		ABORT_=26, ACTION_=27, ADD_=28, AFTER_=29, ALL_=30, ALTER_=31, ANALYZE_=32, 
		AND_=33, AS_=34, ASC_=35, ATTACH_=36, AUTOINCREMENT_=37, BEFORE_=38, BEGIN_=39, 
		BETWEEN_=40, BY_=41, CASCADE_=42, CASE_=43, CAST_=44, CHECK_=45, COLLATE_=46, 
		COLUMN_=47, COMMIT_=48, CONFLICT_=49, CONSTRAINT_=50, CREATE_=51, CROSS_=52, 
		CURRENT_DATE_=53, CURRENT_TIME_=54, CURRENT_TIMESTAMP_=55, DATABASE_=56, 
		DEFAULT_=57, DEFERRABLE_=58, DEFERRED_=59, DELETE_=60, DESC_=61, DETACH_=62, 
		DISTINCT_=63, DROP_=64, EACH_=65, ELSE_=66, END_=67, ESCAPE_=68, EXCEPT_=69, 
		EXCLUSIVE_=70, EXISTS_=71, EXPLAIN_=72, FAIL_=73, FOR_=74, FOREIGN_=75, 
		FROM_=76, FULL_=77, GLOB_=78, GROUP_=79, HAVING_=80, IF_=81, IGNORE_=82, 
		IMMEDIATE_=83, IN_=84, INDEX_=85, INDEXED_=86, INITIALLY_=87, INNER_=88, 
		INSERT_=89, INSTEAD_=90, INTERSECT_=91, INTO_=92, IS_=93, ISNULL_=94, 
		JOIN_=95, KEY_=96, LEFT_=97, LIKE_=98, LIMIT_=99, MATCH_=100, NATURAL_=101, 
		NO_=102, NOT_=103, NOTNULL_=104, NULL_=105, OF_=106, OFFSET_=107, ON_=108, 
		OR_=109, ORDER_=110, OUTER_=111, PLAN_=112, PRAGMA_=113, PRIMARY_=114, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"LT", "LT_EQ", "GT", "GT_EQ", "EQ", "NOT_EQ1", "NOT_EQ2", "BACKTICK", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"PIPE", "LT", "LT_EQ", "GT", "GT_EQ", "EQ", "NOT_EQ1", "NOT_EQ2", "BACKTICK", 
			"ABORT_", "ACTION_", "ADD_", "AFTER_", "ALL_", "ALTER_", "ANALYZE_", 
			"AND_", "AS_", "ASC_", "ATTACH_", "AUTOINCREMENT_", "BEFORE_", "BEGIN_", 
			"BETWEEN_", "BY_", "CASCADE_", "CASE_", "CAST_", "CHECK_", "COLLATE_", 
			"COLUMN_", "COMMIT_", "CONFLICT_", "CONSTRAINT_", "CREATE_", "CROSS_", 
