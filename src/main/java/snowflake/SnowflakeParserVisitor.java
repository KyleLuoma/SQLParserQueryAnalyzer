...
public interface SnowflakeParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SnowflakeParser#projection_alias}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProjection_alias(SnowflakeParser.Projection_aliasContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SnowflakeParser#table_object_name}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTable_object_name(SnowflakeParser.Table_object_nameContext ctx);
	/**
	 * Visit a parse tree produced by {@link SnowflakeParser#relation_alias}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRelation_alias(SnowflakeParser.Relation_aliasContext ctx);
	/**
