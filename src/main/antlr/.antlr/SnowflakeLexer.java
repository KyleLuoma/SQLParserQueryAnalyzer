...
public class SnowflakeLexer extends Lexer {
	...
	public static final int
		...
		FIRST_VALUE=271, FLATTEN=272, FOR=273, FORCE=274, FOREIGN=275, FORMAT=276, 
		FORMATS=277, FORMAT_NAME=278, FREQUENCY=279, FROM=280, FULL=281, FUNCTION=282, 
		FUNCTIONS=283, FUTURE=284, GCP_PUBSUB=285, GCP_PUBSUB_SUBSCRIPTION_NAME=286, 
		GCP_PUBSUB_TOPIC_NAME=287, GCS=288, GCS_SSE_KMS_Q=289, GENERIC_Q=290, 
		GENERIC_SCIM_PROVISIONER_Q=291, GEO=292, GEOGRAPHY_OUTPUT_FORMAT=293, 
		GEOMETRY_OUTPUT_FORMAT=294, GET=295, GETDATE=296, GLOBAL=297, GOOGLE_AUDIENCE=298, 
		GRANT=299, GRANTS=300, GROUP=301, GROUPING=302, GROUPS=303, GZIP=304, 
		HALF_AWAY_FROM_ZERO_Q=305, HALF_TO_EVEN_Q=306, HANDLER=307, HASH=308, 
		HAVING=309, HEADER=310, HEADERS=311, HEX=312, HIGH=313, HISTORY=314, HOURS=315, 
		IDENTIFIER=316, IDENTITY=317, IF=318, IFF=319, IFNULL=320, IGNORE=321, 
		IGNORE_UTF8_ERRORS=322, ILIKE=323, IMMEDIATE=324, IMMEDIATELY=325, IMMUTABLE=326, 
		IMPLICIT=327, IMPORT=328, IMPORTS=329, IMPORTED=330, IN=331, INCREMENT=332, 
		INCREMENTAL=333, INDEX=334, INFORMATION=335, INITIALIZE=336, INITIALLY=337, 
		INITIALLY_SUSPENDED=338, INITIAL_REPLICATION_SIZE_LIMIT_IN_TB=339, INNER=340, 
		INPUT=341, INSERT=342, INSERT_ONLY=343, INT=344, INTEGRATION=345, INTEGRATIONS=346, 
		INTERSECT=347, INTERVAL=348, INTO=349, IS=350, JAVA=351, JAVASCRIPT=352, 
		JDBC_TREAT_DECIMAL_AS_INT=353, JDBC_TREAT_TIMESTAMP_NTZ_AS_UTC=354, JDBC_USE_SESSION_TIMEZONE=355, 
		JOIN=356, JSON=357, JSON_Q=358, JSON_INDENT=359, JS_TREAT_INTEGER_AS_BIGINT=360, 
		...
		POLICIES=527, POLICY=528, PORT=529, POSITION=530, PREFIX=531, PRESERVE_SPACE=532, 
		PREVENT_UNLOAD_TO_INLINE_URL=533, PREVENT_UNLOAD_TO_INTERNAL_STAGES=534, 
		PRE_AUTHORIZED_ROLES_LIST=535, PRIMARY=536, PRIOR=537, PRIORITY=538, PRIVILEGES=539, 
		PROCEDURE=540, PROCEDURES=541, PROCEDURE_NAME=542, PROPERTY=543, PROVIDER=544, 
		PUBLIC=545, PURGE=546, PUT=547, PYTHON=548, QUALIFY=549, QUARTER=550, 
		QUERIES=551, QUERY=552, QUERY_ACCELERATION_MAX_SCALE_FACTOR=553, QUERY_TAG=554, 
		QUEUE=555, QUOTED_IDENTIFIERS_IGNORE_CASE=556, RANK=557, RAW_DEFLATE=558, 
		READ=559, READER=560, RECLUSTER=561, RECORD_DELIMITER=562, RECURSIVE=563, 
		REFERENCES=564, REFERENCE_USAGE=565, REFRESH=566, REFRESH_MODE=567, REFRESH_ON_CREATE=568, 
		REGION=569, REGIONS=570, REGION_GROUP=571, RELY=572, REMOVE=573, RENAME=574, 
		REPEATABLE=575, REPLACE=576, REPLACE_INVALID_CHARACTERS=577, REPLICA=578, 
		REPLICATION=579, REPLICATION_SCHEDULE=580, REQUEST_TRANSLATOR=581, REQUIRE_STORAGE_INTEGRATION_FOR_STAGE_CREATION=582, 
		REQUIRE_STORAGE_INTEGRATION_FOR_STAGE_OPERATION=583, RESET=584, RESOURCE=585, 
		RESOURCES=586, RESOURCE_MONITOR=587, RESPECT=588, RESPONSE_TRANSLATOR=589, 
		RESTRICT=590, RESTRICTIONS=591, RESULT=592, RESUME=593, RETURNS=594, RETURN_ALL_ERRORS=595, 
		RETURN_ERRORS=596, RETURN_FAILED_ONLY=597, RETURN_N_ROWS=598, RETURN_ROWS=599, 
		REVOKE=600, RIGHT=601, RLIKE=602, ROLE=603, ROLES=604, ROLLBACK=605, ROLLUP=606, 
		ROUND=607, ROUNDING_MODE=608, ROW=609, ROWS=610, ROWS_PER_RESULTSET=611, 
		ROW_NUMBER=612, RSA_PUBLIC_KEY=613, RSA_PUBLIC_KEY_2=614, RTRIM=615, RUN_AS_ROLE=616, 
		RUNTIME_VERSION=617, S3=618, SAML2=619, SAML2_ENABLE_SP_INITIATED=620, 
		SAML2_FORCE_AUTHN=621, SAML2_ISSUER=622, SAML2_POST_LOGOUT_REDIRECT_URL=623, 
		SAML2_PROVIDER=624, SAML2_REQUESTED_NAMEID_FORMAT=625, SAML2_SIGN_REQUEST=626, 
		SAML2_SNOWFLAKE_ACS_URL=627, SAML2_SNOWFLAKE_ISSUER_URL=628, SAML2_SNOWFLAKE_X509_CERT=629, 
		SAML2_SP_INITIATED_LOGIN_PAGE_LABEL=630, SAML2_SSO_URL=631, SAML2_X509_CERT=632, 
		SAML_IDENTITY_PROVIDER=633, SAMPLE=634, SAVE_OLD_URL=635, SCALE=636, SCALING_POLICY=637, 
		SCHEDULE=638, SCHEMA=639, SCHEMAS=640, SCIM=641, SCIM_CLIENT=642, SEARCH=643, 
		SECONDARY=644, SECURE=645, SECURITY=646, SECURITYADMIN=647, SEED=648, 
		SELECT=649, SEQUENCE=650, SEQUENCES=651, SESSION=652, SESSION_IDLE_TIMEOUT_MINS=653, 
		SESSION_POLICY=654, SESSION_UI_IDLE_TIMEOUT_MINS=655, SET=656, SETS=657, 
		SHARE=658, SHARES=659, SHARE_RESTRICTIONS=660, SHOW=661, SHOW_INITIAL_ROWS=662, 
		SIMPLE=663, SIMULATED_DATA_SHARING_CONSUMER=664, SIZE_LIMIT=665, SKIP_=666, 
		SKIP_BLANK_LINES=667, SKIP_BYTE_ORDER_MARK=668, SKIP_FILE=669, SKIP_FILE_N=670, 
		SKIP_HEADER=671, SMALL=672, SNAPPY=673, SNAPPY_COMPRESSION=674, SNOWFLAKE_FULL=675, 
		SNOWFLAKE_SSE=676, SNOWPARK_OPTIMIZED=677, SOME=678, SOURCE=679, SOURCE_COMPRESSION=680, 
		SPLIT=681, SPLIT_PART=682, SPLIT_TO_TABLE=683, SQL=684, SSO_LOGIN_PAGE=685, 
		STAGE=686, STAGES=687, STAGE_COPY_OPTIONS=688, STAGE_FILE_FORMAT=689, 
		STANDARD=690, START=691, STARTS=692, START_DATE=693, START_TIMESTAMP=694, 
		STATE=695, STATEMENT=696, STATEMENT_QUEUED_TIMEOUT_IN_SECONDS=697, STATEMENT_TIMEOUT_IN_SECONDS=698, 
		STATS=699, STATUS=700, STORAGE=701, STORAGE_ALLOWED_LOCATIONS=702, STORAGE_AWS_OBJECT_ACL=703, 
		STORAGE_AWS_ROLE_ARN=704, STORAGE_BLOCKED_LOCATIONS=705, STORAGE_INTEGRATION=706, 
		STORAGE_PROVIDER=707, STREAM=708, STREAMS=709, STRICT=710, STRICT_JSON_OUTPUT=711, 
		STRIP_NULL_VALUES=712, STRIP_OUTER_ARRAY=713, STRIP_OUTER_ELEMENT=714, 
		SUBSTR=715, SUBSTRING=716, SUM=717, SUSPEND=718, SUSPENDED=719, SUSPEND_IMMEDIATE=720, 
		SUSPEND_TASK_AFTER_NUM_FAILURES=721, SWAP=722, SYNC_PASSWORD=723, SYSADMIN=724, 
		SYSTEM=725, TABLE=726, TABLEAU_DESKTOP=727, TABLEAU_SERVER=728, TABLES=729, 
		TABLESAMPLE=730, TABLE_FORMAT=731, TABULAR=732, TAG=733, TAGS=734, TARGET_LAG=735, 
		TASK=736, TASKS=737, TEMP=738, TEMPORARY=739, TERSE=740, THEN=741, TIME=742, 
		TIMEADD=743, TIMEDIFF=744, TIMESTAMP=745, TIMESTAMP_DAY_IS_ALWAYS_24H=746, 
		TIMESTAMP_FORMAT=747, TIMESTAMP_INPUT_FORMAT=748, TIMESTAMP_LTZ=749, TIMESTAMP_LTZ_OUTPUT_FORMAT=750, 
		TIMESTAMP_NTZ=751, TIMESTAMP_NTZ_OUTPUT_FORMAT=752, TIMESTAMP_OUTPUT_FORMAT=753, 
		TIMESTAMP_TYPE_MAPPING=754, TIMESTAMP_TZ=755, TIMESTAMP_TZ_OUTPUT_FORMAT=756, 
		TIMESTAMPADD=757, TIMESTAMPDIFF=758, TIMEZONE=759, TIME_FORMAT=760, TIME_INPUT_FORMAT=761, 
		TIME_OUTPUT_FORMAT=762, TO=763, TO_BOOLEAN=764, TO_DATE=765, TO_TIMESTAMP=766, 
		TOP=767, TRANSACTION=768, TRANSACTIONS=769, TRANSACTION_ABORT_ON_ERROR=770, 
		TRANSACTION_DEFAULT_ISOLATION_LEVEL=771, TRANSIENT=772, TRIGGERS=773, 
		TRIM=774, TRIM_SPACE=775, TRUE=776, TRUNC=777, TRUNCATE=778, TRUNCATECOLUMNS=779, 
		TRY_CAST=780, TWO_DIGIT_CENTURY_START=781, TYPE=782, UNDROP=783, UNION=784, 
		UNIQUE=785, UNMATCHED=786, UNPIVOT=787, UNSET=788, UNSUPPORTED_DDL_ACTION=789, 
		UPDATE=790, UPPER=791, URL=792, USAGE=793, USE=794, USER=795, USERADMIN=796, 
		USERS=797, USER_SPECIFIED=798, USER_TASK_MANAGED_INITIAL_WAREHOUSE_SIZE=799, 
		USER_TASK_TIMEOUT_MS=800, USE_ANY_ROLE=801, USE_CACHED_RESULT=802, USING=803, 
		UTF8=804, VALIDATE=805, VALIDATION_MODE=806, VALUE=807, VALUES=808, VARIABLES=809, 
		VERSION=810, VIEW=811, VIEWS=812, VISIBILITY=813, VOLATILE=814, WAREHOUSE=815, 
		WAREHOUSES=816, WAREHOUSE_SIZE=817, WAREHOUSE_TYPE=818, WEEKLY=819, WEEK_OF_YEAR_POLICY=820, 
		WEEK_START=821, WHEN=822, WHERE=823, WITH=824, WITHIN=825, WORK=826, WRITE=827, 
		X4LARGE=828, X5LARGE=829, X6LARGE=830, XLARGE=831, XML=832, XML_Q=833, 
		XSMALL=834, XXLARGE=835, XXXLARGE=836, YEARLY=837, YEAR=838, ZSTD=839, 
		ARRAY=840, ARRAY_Q=841, BIGINT=842, BINARY=843, BOOLEAN=844, BYTEINT=845, 
		CHAR_VARYING=846, DATE=847, DATETIME=848, DECIMAL_=849, DOUBLE=850, DOUBLE_PRECISION=851, 
		FLOAT4=852, FLOAT8=853, FLOAT_=854, FLOOR=855, GEOGRAPHY=856, GEOMETRY=857, 
		INTEGER=858, NCHAR=859, NCHAR_VARYING=860, NUMERIC=861, NVARCHAR2=862, 
		NVARCHAR=863, REAL_=864, SMALLINT=865, STRING_=866, TEXT=867, TINYINT=868, 
		VARBINARY=869, VARCHAR=870, VARIANT=871, LISTAGG=872, DUMMY=873, SPACE=874, 
		SQL_COMMENT=875, LINE_COMMENT=876, LINE_COMMENT_2=877, LINE_COMMENT_3=878, 
		DOUBLE_QUOTE_ID=879, DOUBLE_QUOTE_BLANK=880, SINGLE_QUOTE=881, ID=882, 
		ID2=883, S3_PATH=884, S3GOV_PATH=885, GCS_PATH=886, AZURE_PATH=887, FILE_PATH=888, 
		DBL_DOLLAR=889, STRING=890, DECIMAL=891, FLOAT=892, REAL=893, CHAR_LITERAL=894, 
		ARROW=895, ASSOC=896, NE=897, LTGT=898, EQ=899, GT=900, GE=901, LT=902, 
		LE=903, PIPE_PIPE=904, DOT=905, AT=906, AT_Q=907, DOLLAR=908, LR_BRACKET=909, 
		RR_BRACKET=910, LSB=911, RSB=912, LCB=913, RCB=914, COMMA=915, SEMI=916, 
		COLON=917, COLON_COLON=918, STAR=919, DIVIDE=920, MODULE=921, PLUS=922, 
		MINUS=923, TILDA=924;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"GENERIC_Q", "GENERIC_SCIM_PROVISIONER_Q", "GEO", "GEOGRAPHY_OUTPUT_FORMAT", 
			...
			"PORT", "POSITION", "PREFIX", "PRESERVE_SPACE", "PREVENT_UNLOAD_TO_INLINE_URL", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'POLICIES'", "'POLICY'", "'PORT'", "'POSITION'", "'PREFIX'", "'PRESERVE_SPACE'", 
	...
	private static final String _serializedATNSegment1 =
		...
		"\u0396\u0737\u0397\u0739\u0398\u073b\u0399\u073d\u039a\u073f\u039b\u0741"+
		"\u039c\u0743\u0000\u0745\u0000\u0001\u0000,\u0002\u0000AAaa\u0002\u0000"+
		"DDdd\u0002\u0000PPpp\u0002\u0000RRrr\u0002\u0000OOoo\u0002\u0000VVvv\u0002"+
		"\u0000IIii\u0002\u0000SSss\u0002\u0000NNnn\u0002\u0000EEee\u0002\u0000"+
		"BBbb\u0002\u0000TTtt\u0002\u0000CCcc\u0002\u0000HHhh\u0002\u0000QQqq\u0002"+
		"\u0000UUuu\u0002\u0000YYyy\u0002\u0000MMmm\u0002\u0000WWww\u0002\u0000"+
		"FFff\u0002\u0000LLll\u0002\u0000GGgg\u0002\u0000KKkk\u0002\u0000XXxx\u0002"+
		"\u0000ZZzz\u0002\u0000JJjj\u0003\u0000\t\n\r\r  \u0002\u0000\n\n\r\r\u0001"+
		"\u0000\"\"\u0003\u0000AZ__az\u0005\u0000$$09@Z__az\u0004\u000009AZ__a"+
		"z\u0001\u0000$$\u0002\u0000\'\'\\\\\u0002\u0000++--\u0004\u0000\n\n\r"+
		"\r\'\'\\\\\r\u0000\"\"\'\'BBFFNNRRTT\\\\bbffnnrrtt\u0001\u000003\u0001"+
		"\u000007\u0003\u000009AFaf\u0005\u0000..09AZaz||\u0006\u0000++-.09AZa"+
		"z||\u0002\u0000AZaz\u0001\u000009\u31e8\u0000\u0001\u0001\u0000\u0000"+
		"\u0000\u0000\u0003\u0001\u0000\u0000\u0000\u0000\u0005\u0001\u0000\u0000"+
		"\u0000\u0000\u0007\u0001\u0000\u0000\u0000\u0000\t\u0001\u0000\u0000\u0000"+
		"\u0000\u000b\u0001\u0000\u0000\u0000\u0000\r\u0001\u0000\u0000\u0000\u0000"+
