...
public interface PostgreSQLParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterEnclosed_bracket_expr(PostgreSQLParser.Enclosed_bracket_exprContext ctx);
	/**
	 * Exit a parse tree produced by {@link PostgreSQLParser#enclosed_bracket_expr}.
	 * @param ctx the parse tree
	 */
	void exitEnclosed_bracket_expr(PostgreSQLParser.Enclosed_bracket_exprContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterTarget_el_alias(PostgreSQLParser.Target_el_aliasContext ctx);
	/**
	 * Exit a parse tree produced by {@link PostgreSQLParser#target_el_alias}.
	 * @param ctx the parse tree
	 */
	void exitTarget_el_alias(PostgreSQLParser.Target_el_aliasContext ctx);
	/**
